...
public class UIPistolAnimation : MonoBehaviour {
    [HideInInspector] public static UIPistolAnimation instance;
    ...
    void Update() {
        if (PlayerMovementBehaviour.instance._movementDirection.x > .02 || PlayerMovementBehaviour.instance._movementDirection.x < -.02
            || PlayerMovementBehaviour.instance._movementDirection.z > .02 || PlayerMovementBehaviour.instance._movementDirection.z < -.02) {
            GunSway();
        } else {
